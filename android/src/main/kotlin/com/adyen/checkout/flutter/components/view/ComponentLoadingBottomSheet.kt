...
class ComponentLoadingBottomSheet<T> : BottomSheetDialogFragment() where T : Component, T : ViewableComponent {
    ...
    companion object {
        ...
        fun hide(activity: FragmentActivity) {
            ...
            activity.supportFragmentManager.findFragmentByTag(COMPONENT_LOADING_BOTTOM_SHEET_TAG)?.let {
        ...
        private fun <T> initViewModelAndAssignComponent(
            ...
            val viewModel =
                ViewModelProvider(
                    activity
                )[ComponentLoadingBottomSheetViewModel::class.java] as ComponentLoadingBottomSheetViewModel<T>
